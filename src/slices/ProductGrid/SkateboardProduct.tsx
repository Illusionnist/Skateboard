...
async function getDominantColor(url: string) {
  ...
  return (
    json.dominant_colors.vibrant?.hex || json.dominant_colors.vibrant_dark?.hex
  );
}
    ...
    <div className="group relative mx-auto w-full max-w-72 px-8 pt-4">
      ...
      <div className="-mb-1 overflow-hidden py-4 ">
        ...
        <PrismicNextImage
          ...
          width={150}
          className="mx-auto w-[58%] origin-top transform-gpu transition-transform duration-500 group-hover:scale-150"
        ></PrismicNextImage>
      </div>
      <HorizontalLine className={HORIZONTAL_LINE_CLASSES} />
      ...
      <div className=" absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-200 group-hover:opacity-100 text-right">
